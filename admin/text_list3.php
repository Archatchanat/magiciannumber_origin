...
<?
	if($_GET["action"]=="insert")
	{
		...
		if(trim($_FILES["fileUpload"]["tmp_name"]) != "")
		{
			...
			copy($_FILES["fileUpload"]["tmp_name"],"../pic_text3/".$_FILES["fileUpload"]["name"]);
			...
			ImageJPEG($images_fin,"../pic_text3/".$new_images);
		...
		echo "window.location='text_list3.php';";
		echo "</script>";
    }
?>
...
<body>
    <div class="main">
			...
			<tr>
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="text_list3.php">รายการบทความ</a>
				</td>
			</tr>
			<tr> 
...
<table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr>
				<td align="right" colspan="2">
				<img src="images/plus_16.png" width="16" height="16" /> <a href="text_list3.php">รายการบทความ</a>				</td>
			</tr>
			...
			<tr>
				<td width="16%" align="right">ภาพ :</td>
				<td width="84%"><img src="../pic_text3/<?=$new_pic?>" width="84" height="82"></td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					&nbsp;&nbsp;<a href="text_list3.php">[ ย้อนกลับ ]</a>				</td>
			</tr>
		  ...
		  <table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr> 
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="text_list3.php?add=true">เพิ่มบทความ</a></span>
				</td>
			</tr>
			...
			?>
					...
					<? } ?>
						...
						<td>
							<img src="../pic_text3/<?=$rs_text['new_pic']?>">
						</td>
