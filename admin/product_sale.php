...
<?php
	...
	if($_GET["action"]=="del_sel")
	{
		...
		echo "window.location='product_sale.php';";
		echo "</script>";
		exit();
	}
...
<body>
    <div class="main">
			...
			<tr>
				<td align="right" colspan="8">&nbsp;<img src="images/plus_16.png"><a href="product_sale.php">รายการเบอร์โทรศัพท์</a></td>
			</tr>
			<tr> 
			...
			<tr>
				...
				<td width="48%" rowspan="19" valign="top">
					...
					<table width="100%">
						...
						<tr>
							<td width="38%" align="right">คะแนนความดี ::</td>
							<td width="62%"><input name="p_good" type="text"  size="10" maxlength="10"></td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
						</tr>	
						...
						<tr>
							...
							<td><input name="help_name" type="text"  size="20" maxlength="20"></td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
						</tr>
						<tr>
							...
							<td><input name="help_email" type="text"  size="20" maxlength="20"></td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
						</tr>
						<tr>
							...
							<td><input name="help_tel" type="text"  size="20" maxlength="20"></td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
						</tr>
						<tr>
							...
							<td><textarea name="help_address" rows="5" cols="30"></textarea></td>
						</tr>
			...
			<tr>
				...
				<td width="33%" align="left">
						...
						<br/>
						<input type="radio" name="p_network" value="HUTCH">HUTCH
						<input type="radio" name="p_network" value="CATCDMA">CATCDMA
						<input type="radio" name="p_network" value="IMOBILE">IMOBILE
				</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			...
			<tr>
				...
				<td width="33%" align="left">
					<input type="radio" name="p_sale" value="no" checked="checked">ยังไม่ได้ขาย
					<input type="radio" name="p_sale" value="yes"> ขายแล้ว
				</td>
			</tr>
			...
			?>
				...
				<tr> 
					<td colspan="3" bgcolor="#999999"align="left">
						...
						<p>$sub_id = <?=$sub_id?> $sub_title = <?=$sub_title?></p> -->					
					</td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
	...
	<option value="<?=$rs_cat['cat_id']?>&fix=true&p_id=<?=$_GET['p_id']?>&stack=<?=$_GET['stack']?>&type_stack=<?=$_GET['type_stack']?>">
		...
		&nbsp;&nbsp;<a href="product_sale.php?stack=<?=$_GET['stack']?>&type_stack=<?=$_GET['type_stack']?>&Page=<?=$_GET['Page']?>">[ ย้อนกลับ ]</a>					
					</td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
		  ...
		  <table width="90%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
			<tr> 
				<td colspan="12" background="images/bghead.png"align="left">
					<font color="#FFFFFF" size="+1">&nbsp;รายการเบอร์โทรศัพท์ที่ขายแล้ว</font>				
				</td>
			</tr>
			<tr>
				<td colspan="12">&nbsp;
