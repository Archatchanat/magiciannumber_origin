...
<table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr> 
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="text_list1.php?add=true">เพิ่มบทความ</a></span>				</td>
			</tr>
			
			<tr> 
				<td colspan="8" background="images/bghead.png"align="left">
					<font color="#FFFFFF" size="+1">&nbsp;รายการบทความ</font>				</td>
			</tr>
			...
			<tr bgcolor="#CCCCCC" height="22px;">
				...
				<td width="" align="center">
					<? if($_GET['type_stack']=="" || $_GET['type_stack']=="DESC"){?>
   						<a href="?stack=mp_detail&type_stack=ASC"><font color="#000033">รายละเอียด</font></a>
					<? }else { ?>
   						<a href="?stack=mp_detail&type_stack=DESC"><font color="#000033">รายละเอียด</font></a>
					<? } ?>				
				</td>
			...
			?>
					...
					<? } ?>
						...
						<td>
							<strong>
								<?
									...
									$num3 = substr($rs_text['p_number'],3,4);
									echo $num1."-".$num2."-".$num3;
								?>
							</strong>
						</td>
						...
						<td align="center">
						<a href="?fix=true&mp_id=<?=$rs_text['mp_id']?>"><img src="images/b_edit.png" width="16" height="16" border="0"></a>
						</td>
						<td align="center">
