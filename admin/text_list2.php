...
<?
	if($_GET["action"]=="insert")
	{
		...
		echo "window.location='text_list2.php';";
		echo "</script>";
    }
?>
...
<body>
    <div class="main">
			...
			<tr>
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="text_list2.php">รายการบทความ</a>
				</td>
			</tr>
			<tr> 
...
<table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr>
				<td align="right" colspan="2">
				<img src="images/plus_16.png" width="16" height="16" /> <a href="text_list2.php">รายการบทความ</a>				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					&nbsp;&nbsp;<a href="text_list2.php">[ ย้อนกลับ ]</a>				</td>
			</tr>
		  ...
		  <table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr> 
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="text_list2.php?add=true">เพิ่มบทความ</a></span>
				</td>
			</tr>
