...
<?
	...
	{
		$tellway  = "INSERT INTO text3 VALUES(";
		$tellway .= "0
					,'$_POST[text_title]'
					,'$_POST[text_content]'
					,'$_POST[text_post]'
		...
		echo "window.location='port_tvc_company.php';";
		echo "</script>";
    }
?>
...
<?
	...
	if($_GET["del"]=="true")
	{
		$sql_del= "delete from text3 where text_id='".$_GET["text_id"]."'";
...
<body>
    <div class="main">
			...
			<tr>
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="port_tvc_company.php">TVC Company List</a>
				</td>
			</tr>
			<tr> 
				<td colspan="2" background="images/bghead.png"align="left">
					<font color="#FFFFFF" size="+0">&nbsp;Add Company</font>				
				</td>
			</tr>
			...
			<tr>
				<td width="16%" align="right">Company Name :</td>
...
<table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr>
				<td align="right" colspan="2">
				<img src="images/plus_16.png" width="16" height="16" /> <a href="port_tvc_company.php">TVC Company List</a>				</td>
			</tr>
			...
			<tr> 
				<td colspan="2" align="left" bgcolor="#999999">
					<font color="#FFFFFF" size="+0">&nbsp;Fix Company :: <? echo "<font color=red>[ ".$_GET['text_id']." ]</font>"?></font>				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					&nbsp;&nbsp;<a href="port_tvc_company.php">[ Back ]</a>				</td>
			</tr>
		  ...
		  <table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr> 
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="port_tvc_company.php?add=true">Add Company</a></span>
				</td>
			</tr>
			
			<tr> 
				<td colspan="8" background="images/bghead.png"align="left">
					<font color="#FFFFFF" size="+1">&nbsp;TVC Company List</font>				
				</td>
			</tr>
			...
			<tr bgcolor="#CCCCCC" height="22px;">
				...
				<td align="center">
					<? if($_GET['type_stack']=="" || $_GET['type_stack']=="DESC"){?>
   						<a href="?stack=text.text_title&type_stack=ASC"><font color="#000033">Company Name</font></a>
					<? }else { ?>
   						<a href="?stack=text.text_title&type_stack=DESC"><font color="#000033">Company Name</font></a>
					<? } ?>
				</td>
			...
			?>
					...
					<? } ?>
						...
						<td>
							<a href="port_tvc_project.php?text_id=<?=$rs_text['text_id']?>">Project List</a> <!--|
