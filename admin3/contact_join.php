...
<?
	...
	{
		$tellway  = "INSERT INTO text2 VALUES(";
		$tellway .= "0
					,'$_POST[text_title]'
					,'$_POST[text_content]'
					,'$_POST[text_post]'
		...
		echo "window.location='contact_join.php';";
		echo "</script>";
    }
?>
...
<?
	...
	if($_GET["del"]=="true")
	{
		$sql_del= "delete from text2 where text_id='".$_GET["text_id"]."'";
...
<body>
    <div class="main">
			...
			<tr>
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="contact_join.php">Postion List</a>
				</td>
			</tr>
			<tr> 
				<td colspan="2" background="images/bghead.png"align="left">
					<font color="#FFFFFF" size="+0">&nbsp;Add Position</font>				
				</td>
			</tr>
			...
			<tr>
				<td width="16%" align="right">Position :</td>
			...
			<tr>
				<td align="right">Specification :</td>
				<td>
					<?php 
...
<table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr>
				<td align="right" colspan="2">
				<img src="images/plus_16.png" width="16" height="16" /> <a href="contact_join.php">Postion List</a>				</td>
			</tr>
			...
			<tr> 
				<td colspan="2" align="left" bgcolor="#999999">
					<font color="#FFFFFF" size="+0">&nbsp;Fix Position No :: <? echo "<font color=red>[ ".$_GET['text_id']." ]</font>"?></font>				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					&nbsp;&nbsp;<a href="contact_join.php">[ Back ]</a>				</td>
			</tr>
		  ...
		  <table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr> 
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="contact_join.php?add=true">Add Position</a></span>
				</td>
			</tr>
			
			<tr> 
				<td colspan="8" background="images/bghead.png"align="left">
					<font color="#FFFFFF" size="+1">&nbsp;Position List</font>				
				</td>
			</tr>
			...
			<tr bgcolor="#CCCCCC" height="22px;">
				...
				<td align="center">
					<? if($_GET['type_stack']=="" || $_GET['type_stack']=="DESC"){?>
   						<a href="?stack=text.text_title&type_stack=ASC"><font color="#000033">Position</font></a>
					<? }else { ?>
   						<a href="?stack=text.text_title&type_stack=DESC"><font color="#000033">Position</font></a>
					<? } ?>
				</td>
