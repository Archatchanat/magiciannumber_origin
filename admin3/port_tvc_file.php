...
<?
	if($_GET["action"]=="insert")
	{
		...
		$tellway  = "INSERT INTO port_tvc_file VALUES(";
		$tellway .= "0
					,'".$new_images."'
		...
		echo "window.location='port_tvc_file.php';";
		echo "</script>";
    }
?>
...
<?
	...
	if($_GET["del"]=="true")
	{
		$sql_del= "delete from port_tvc_file where text_id='".$_GET["text_id"]."'";
...
<body>
    <div class="main">
			...
			<tr>
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="port_tvc_file.php">File List</a>
				</td>
			</tr>
			<tr> 
				<td colspan="2" background="images/bghead.png"align="left" style="padding:3px;">
					<font color="#FFFFFF" size="+0">&nbsp;Add TVC File</font>			
				</td>
			</tr>
			...
			<tr>
				<td width="16%" align="right">File :</td>
			...
			<tr>
				<td width="16%" align="right">File Name :</td>
...
<table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr>
				<td align="right" colspan="2">
				<img src="images/plus_16.png" width="16" height="16" /> <a href="port_tvc_file.php">File List</a>				</td>
			</tr>
			...
			<tr> 
				<td colspan="2" align="left" bgcolor="#999999">
					<font color="#FFFFFF" size="+0">&nbsp;Fix TVC File No :: <? echo "<font color=red>[ ".$_GET['text_id']." ]</font>"?></font>	
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					&nbsp;&nbsp;<a href="port_tvc_file.php">[ Back ]</a>				</td>
			</tr>
		  ...
		  <table width="90%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			...
			<tr> 
				...
				<img src="images/plus_16.png" width="16" height="16" /> <a href="port_tvc_file.php?add=true">Add File</a></span>
				</td>
			</tr>
			
			<tr> 
				<td colspan="8" background="images/bghead.png"align="left" style="padding:3px;">
					<font color="#FFFFFF" size="+0">&nbsp;TVC File List</font>			
				</td>
			</tr>
