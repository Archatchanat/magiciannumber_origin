...
$mail->SMTPAuth = "true";
$mail->Username = "test@yourdomain.com"; // ชื่อ emil ที่ท่านใช้ login ควรสร้าง email user แยกต่างหากเพื่อใช้ส่งเมล์จากเว็บโดยเฉพาะเพื่อให้ตรวจสอบได้ง่าย
$mail->Password = "12345"; // รหัสผ่านของ email ที่ระบุด้านบน
